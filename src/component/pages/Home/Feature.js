  ...
  return (
    ...
    <div className='row'>
    {
        FeatureData.map((feature,index)=>(
            ...
            <span style={{border:'1px solid white',padding:'3px',backgroundColor:'white',color:'black' ,borderRadius:'50%',width:'40px',height:'40px',textAlign:'center'}}>{feature.id}</span>
            <p>{feature.para}</p>
